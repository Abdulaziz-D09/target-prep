...
def parse_module(text, start_marker, end_marker=None):
    ...
    for i in range(len(parts) - 1):
        ...
        if "Math" in start_marker:
            ...
            if len(lines) > 1:
                # Find the line that is the prompt
                prompt_idx = -1
        ...
        # Extract __IMAGE__ block from passage/question and store separately
        image = ""
...
eng_m1_ts = "const pt2_englishModule1: Question[] = " + format_ts_questions(eng_m1, "reading", 1)
eng_m2_ts = "const pt2_englishModule2: Question[] = " + format_ts_questions(eng_m2, "reading", 2)
math_m1_ts = "const pt2_mathModule1: Question[] = " + format_ts_questions(math_m1, "math", 1)
math_m2_ts = "const pt2_mathModule2: Question[] = " + format_ts_questions(math_m2, "math", 2)
...
content = replace_block(content, "pt2_englishModule1", eng_m1_ts, "pt2_englishModule2")
content = replace_block(content, "pt2_englishModule2", eng_m2_ts, "pt2_mathModule1")
content = replace_block(content, "pt2_mathModule1", math_m1_ts, "pt2_mathModule2")
content = replace_block(content, "pt2_mathModule2", math_m2_ts, None)

with open('src/data/questions.ts', 'w') as f:
    f.write(content)
    
print("Re-injected ALL 4 modules successfully!")
